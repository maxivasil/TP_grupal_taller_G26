...
inline const std::unordered_map<std::string, CarStats> CarStatsDatabase::stats_map = {
    ...
    {"Iveco Daily", CarStats{
        .acceleration = 10.0f,    // Baja aceleración
    ...
    {"Dodge Viper", CarStats{
        .acceleration = 35.0f,    // Aceleración máxima
    ...
    // CELESTE - Equilibrado
    {"Chevrolet Corsa", CarStats{
        .acceleration = 20.0f,    // Aceleración normal
    ...
    {"Jeep Wrangler", CarStats{
        .acceleration = 18.0f,    // Aceleración buena
    ...
    {"Toyota Tacoma", CarStats{
        .acceleration = 12.0f,    // Aceleración baja
    ...
    {"Lincoln TownCar", CarStats{
        .acceleration = 14.0f,    // Aceleración baja
        ...
        .length = 5.8f,           // Muy largo
        .width = 2.0f
    }},

    // DESCAPOTABLE - Deportivo
    {"Lamborghini Diablo", CarStats{
        .acceleration = 32.0f,    // Aceleración muy alta
