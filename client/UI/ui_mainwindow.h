...
public:
    ...
    void setupUi(QMainWindow* MainWindow) {
        ...
        Van->setGeometry(QRect(521, 440, 111, 121));
        ...
        Ferrari->setGeometry(QRect(641, 440, 111, 121));
        ...
        Celeste->setGeometry(QRect(761, 440, 111, 121));
        ...
        Jeep->setGeometry(QRect(891, 440, 111, 121));
        ...
        Pickup->setGeometry(QRect(1021, 440, 121, 121));
        ...
        Limo->setGeometry(QRect(1161, 420, 101, 141));
        ...
        Descapotable->setGeometry(QRect(1271, 470, 121, 91));
        ...
        intro_text->setGeometry(QRect(521, 640, 891, 131));
        QFont font;
        ...
        QFont lobbyFont;
        lobbyFont.setFamily(QString::fromUtf8("Uroob"));
        lobbyFont.setPointSize(32);
        Lobby_text->setFont(lobbyFont);
        ...
        Ready->setGeometry(QRect(821, 580, 281, 41));
        QFont font1;
