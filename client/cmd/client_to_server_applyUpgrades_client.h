#ifndef CLIENT_TO_SERVER_APPLY_UPGRADES_CLIENT_H
#define CLIENT_TO_SERVER_APPLY_UPGRADES_CLIENT_H
 ...
 */
class ClientToServerApplyUpgrades_Client: public ClientToServerCmd_Client {
public:
    explicit ClientToServerApplyUpgrades_Client(const CarUpgrades& upgrades);
...
#endif  // CLIENT_TO_SERVER_APPLY_UPGRADES_CLIENT_H
