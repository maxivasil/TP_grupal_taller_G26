...
public:
    ...
    void setWorldOffset(float ox, float oy) {
        offsetX = ox;
        offsetY = oy;
    }
    ...
    void render(SDL2pp::Renderer& renderer, const MinimapPlayer& localPlayer,
                const std::vector<MinimapPlayer>& otherPlayers, int nextCheckpointId = 0);
