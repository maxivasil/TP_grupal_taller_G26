...
ServerToClientJoinLobbyResponse_Server::ServerToClientJoinLobbyResponse_Server(
        uint8_t status, const std::string& lobbyId):
...
ServerToClientJoinLobbyResponse_Server::ServerToClientJoinLobbyResponse_Server(uint8_t status,
                                                                               uint8_t errorCode):
...
std::vector<uint8_t> ServerToClientJoinLobbyResponse_Server::to_bytes() const {
...
ServerToClientJoinLobbyResponse_Server* ServerToClientJoinLobbyResponse_Server::clone() const {
    return new ServerToClientJoinLobbyResponse_Server(*this);
}
