...
ServerToClientRaceResults::ServerToClientRaceResults(): isFinished(false) {}

ServerToClientRaceResults::ServerToClientRaceResults(const std::vector<PlayerResult>& playerResults,
                                                     bool finished):
