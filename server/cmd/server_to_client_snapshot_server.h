...
class ServerToClientSnapshot_Server: public ServerToClientCmd_Server {
private:
    std::vector<CarSnapshot> cars;
    float elapsedTime;

public:
    ServerToClientSnapshot_Server(const std::vector<CarSnapshot>& cars, float elapsedTime);
...
#endif  // SERVER_TO_CLIENT_SNAPSHOT_SERVER_H
