...
public:
    ...
    void initializeCityFromCheckpoints(const std::string& cityName,
        ...
        if (checkpoints.empty()) {
            ...
            std::cerr << "[NPC Route Manager] No checkpoints provided for " << cityName << std::endl;
            return;
        }
        ...
        std::cout << "[NPC Route Manager] Generadas " << routes.size() 
                  << " rutas para " << cityName << " desde " << checkpoints.size() 
